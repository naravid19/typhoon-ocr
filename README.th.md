...
- 🤖 **ระบบอัจฉริยะ Smart Resume & Auto-Retry**: กดปุ่มเดิมเพื่อรันทำงานต่อเฉพาะไฟล์ที่ติด Error (เช่น Rate Limit HTTP 429) โดยไม่ต้องเริ่มใหม่ทั้งหมด
- ⚙️ **ตั้งค่าขีดจำกัดไฟล์**: ปรับแก้ไขจำนวนอัปโหลดสูงสุดต่อครั้งได้ง่ายๆ ผ่านหน้า Settings
...
- ✅ นำเข้าเอกสารจาก URL (ผ่าน CORS proxy พร้อมระบบตรวจจับประเภทไฟล์สำรอง)
...
- [x] **ประมวลผลแบบหลายไฟล์พร้อมกัน (Batch processing สูงสุด 10 ไฟล์)**
- [x] **ส่งออกเป็นไฟล์ Markdown (`.md`) และ ZIP archive (`.zip`) (แบบแยกและแบบรวม)**
